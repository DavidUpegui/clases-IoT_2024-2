# Actividad - Aplicación de IoT en la vida real
...
|3|Smart Cities: Solving Urban Problems Using Technology [[link]](https://www.youtube.com/watch?v=nnyRZotnPSU)|Technology, Innovation, Data, Smart City|@AlejoAriasO|
...
|33|Drones, hackers y mercenarios - Los campos de batalla del futuro [[link]](https://www.youtube.com/watch?v=2z3l2AcXlWw&rco=1)|kamikaze drones, Army of drones, frequency, Drones, remote viewing, Interference|@haidergl323|
...
|---|---|---|---|---|---|---|---|---|
|1|Waste management|5|IoT usado en contenedores de basura con el objetivo de optimizar la recogida de desperdicios e insentivar su buen uso|Poca eficiencia en el manejo de desperdicios en la ciudad|Usar IoT para obtener variables de los contenedores que permitiecen conocer su estado para realizar un mejor manejo de los contenedores. Además, incluye sistemas de recompensa para incentivar el buen uso de los contenedores|1|Optimization, Waste, Environtment Friendly, Internet of Things|@DavidUpegui|
...
|3|sustainable urban environment|8|La imagen presenta un enfoque sobre cómo los ciudadanos pueden interactuar y participar en la toma de decisiones sobre políticas ambientales urbanas en tiempo real.|La toma de decisiones en políticas ambientales es un desafío debido a la complejidad y a la cantidad de datos involucrados|Usar el Internet de las Cosas (IoT) para permitir la participación ciudadana en la formulación de políticas basadas en datos en tiempo real.|4|IoT, policymaking, urban environment, citizen participation|@AlejoAriasO|
